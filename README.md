...
## انتقال سبک برای افزایش داده‌های آموزشی شبکه‌های پیچشی در شناسایی شعله‌ی آتش
...
در ادامه برخی از شکل‌های مقاله، تصاویر دیگر مرتبط که به علت حجم زیاد در مقاله نیامده‌اند و برنامه‌ی آموزش شبکه را ملاحظه خواهیم کرد.
