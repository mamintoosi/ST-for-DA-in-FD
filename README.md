...
@article{Amintoosi1400_ST-for-DA-in-FD,
    ...
    title = {انتقال سبک برای افزایش داده‌های آموزشی شبکه‌های کانولوشنی در شناسایی شعله‌ی آتش},
...
<div dir="rtl">
در ادامه، برنامه‌ی آموزش شبکه و تصاویر دیگر مرتبط با متن مقاله که به علت حجم زیاد در مقاله نیامده‌اند  را ملاحظه خواهیم کرد.
...
<div dir="rtl">
توضیحات مختصر مربوط به آموزش مدل در برنامه فوق درج شده است.
